...
call pgmnt#compile(
      ...
      \   'output': '../autoload/airline/themes/euclid.vim',
      \   'template': './template-airline.vim',
      \ })
call pgmnt#compile(
      \ s:create_xline_context(), {
      \   'output': '../autoload/lightline/colorscheme/euclid.vim',
